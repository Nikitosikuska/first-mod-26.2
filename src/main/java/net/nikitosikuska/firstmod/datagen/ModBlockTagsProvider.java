...
public class ModBlockTagsProvider extends FabricTagsProvider.BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NonNull Provider registries) {
        ...
        tag(BlockTags.NEEDS_DIAMOND_TOOL)
                .add(BuiltInRegistries.BLOCK.getResourceKey(ModBlocks.FLUORITE_NETHER_ORE).orElseThrow())
                .add(BuiltInRegistries.BLOCK.getResourceKey(ModBlocks.FLUORITE_END_ORE).orElseThrow());
        tag(BlockTags.STAIRS).add(BuiltInRegistries.BLOCK.getResourceKey(ModBlocks.FLUORITE_STAIRS).orElseThrow());
        tag(BlockTags.SLABS).add(BuiltInRegistries.BLOCK.getResourceKey(ModBlocks.FLUORITE_SLAB).orElseThrow());
        ...
        tag(BlockTags.WALLS).add(BuiltInRegistries.BLOCK.getResourceKey(ModBlocks.FLUORITE_WALL).orElseThrow());
